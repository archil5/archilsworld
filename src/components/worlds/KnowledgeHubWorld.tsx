...
const MODULES: KnowledgeModule[] = [
  ...
  },
  {
    ...
    description: "35+ patterns with live SVG diagrams, trade tips, and a game mode to test if you can name them by sight.",
    icon: "🕯️",
    ...
    items: 35,
    itemLabel: "patterns",
    interactiveBadge: "🎮 Game Mode",
    interactiveDetail: "Name That Pattern · streak counter · score",
  },
  {
    id: "cloud-patterns",
    ...
    items: 10,
    itemLabel: "patterns",
    interactiveBadge: "🧠 Architect Challenge",
    interactiveDetail: "4 real scenarios · pick the right pattern",
  },
  {
    id: "system-design",
    title: "System Design",
    description: "Core concepts from a practitioner — rate limiting, caching, sharding, load balancing with real production notes.",
    icon: "⚙️",
    ...
    interactiveDetail: "5 live scenarios · 3 choices · see the tradeoffs",
  },
  {
    id: "mental-models",
    title: "Mental Models & Puzzles",
    description: "Thinking frameworks used in real engineering decisions, plus scored logic puzzles with a 90-second timer.",
    icon: "🧩",
    ...
    interactiveBadge: "⏱️ Scored Puzzles",
    interactiveDetail: "90s timer · hint penalties · session score",
  },
];
      ...
      <motion.div className="max-w-3xl mx-auto"
        ...
        <div className="text-center mb-10">
          <motion.div
            ...
            <span className="font-mono text-xs uppercase tracking-[0.2em]" style={{ color: COPPER }}>
              Interactive Guides
            </span>
          </motion.div>

          <h2 className="font-display text-2xl md:text-3xl font-bold mb-3" style={{ color: INK }}>
            Knowledge Center
          </h2>
          <p className="font-mono text-xs max-w-md mx-auto leading-relaxed" style={{ color: INK_MUTED }}>
            Deep dives into topics I find fascinating — written from real experience, not textbooks.
            Every module has a game, quiz, or challenge built in.
          </p>

          {/* Stats */}
          <motion.div className="flex items-center justify-center gap-6 mt-5"
            ...
            {[
              ...
              <div key={i} className="text-center">
                ...
                <p className="font-mono text-[10px] uppercase tracking-[0.15em]" style={{ color: INK_MUTED }}>{stat.label}</p>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
          {MODULES.map((mod, i) => (
            <motion.button key={mod.id}
              ...
              disabled={!mod.ready}
              className="relative text-left p-5 md:p-6 transition-all group disabled:cursor-default overflow-hidden rounded-xl"
              style={{
              ...
              <div className="relative z-10 flex items-start gap-4">
                <motion.div className="w-12 h-12 flex items-center justify-center shrink-0 text-2xl rounded-xl"
                  style={{ background: `${mod.color}10`, border: `1px solid ${mod.color}15` }}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-mono text-xs leading-relaxed mb-3" style={{ color: INK_MUTED }}>
                    {mod.description}
                  </p>
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="font-mono text-[10px] px-2 py-0.5 rounded-full"
                      style={{ background: `${mod.color}10`, color: mod.color, border: `1px solid ${mod.color}20` }}>
                      {mod.interactiveBadge}
                    </span>
                    <span className="font-mono text-[10px] ml-auto" style={{ color: mod.color }}>
                      {mod.items} {mod.itemLabel}
                    </span>
                  </div>

                  {/* Interactive detail */}
                  <p className="font-mono text-[10px] mt-1.5" style={{ color: `${INK_MUTED}70` }}>
                    {mod.interactiveDetail}
                  </p>
                </div>
              </div>
              ...
              {mod.ready && (
                <motion.div
                  className="absolute bottom-3 right-4 font-mono text-[10px] tracking-wider flex items-center gap-1"
        ...
        <motion.p className="text-center font-mono text-[10px] mt-8 leading-relaxed"
