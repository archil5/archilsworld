...
export const CHAPTERS: ChapterData[] = [
  ...
  },
  {
    ...
    subtitle: "Guides, patterns & mental models — distilled",
    narrative: "A growing collection of interactive guides on topics I care about — from trading patterns to cloud architecture to mental models.",
    tagline: "Learn something new in five minutes or less",
    exploreHint: "Explore this world →",
    skills: ["Finance", "Cloud", "Architecture", "Patterns"],
    position: [9, 0, -3],
    color: "#2a7d5f",
  },
  {
